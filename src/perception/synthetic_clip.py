...
def _script() -> list[Actor]:
    ...
    return [
        Actor("A1", "A", TEAM_A_COLOR_BGR, [(0, 20, 34), (3, 35, 30), (3.5, 38, 30), (5, 45, 30), (8, 55, 32), (10, 55, 32)]),
        ...
        Actor("B1", "B", TEAM_B_COLOR_BGR, [(0, 55, 32), (2.5, 44, 33), (3.3, 42.5, 34.2), (5, 55, 45), (10, 55, 45)]),
        ...
        Actor(
            ...
            [(0, 30, 40), (3, 42, 34), (3.3, 42.5, 34.2), (3.6, 40, 32), (5, 45, 30), (6.5, 60, 27), (8, 95, 32), (9.5, 104, 34)],
        ),
    ]
